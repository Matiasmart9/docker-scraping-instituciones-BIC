...
from app.api.endpoints import auth, instituciones, sync, contactos, notificaciones, kpi_cargas, kpi_desvinculadas
...
app.include_router(kpi_desvinculadas.router, prefix="/api/v1")
