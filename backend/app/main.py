...
from app.api.endpoints import auth, instituciones, sync, contactos, notificaciones, kpi_cargas, kpi_movimientos, configuracion
...
app.include_router(kpi_movimientos.router, prefix="/api/v1")
